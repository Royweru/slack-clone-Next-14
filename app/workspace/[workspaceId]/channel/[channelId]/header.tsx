...
import { useRemoveChannel } from "@/features/channels/api/use-remove-channnel";
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    updateChannel(
      { id: channelId, name: value },
      {
        ...
        onError(error) {
          toast.error("something wetn wrong");
        },
      }
    );
  };
              ...
              <DialogContent>
                ...
                <form action="" className=" space-y-4" onSubmit={handleSubmit}>
                  ...
                  <DialogFooter>
                    ...
                    <Button disabled={updatingChannel} type="submit">
                      Save
                    </Button>
                  </DialogFooter>
                </form>
